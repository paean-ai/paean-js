...
import type { AtlasFrame } from './PixelAtlas.js';
import type { SpriteClip } from './PixelSprite.js';
import type { TileMapDefinition } from './TileMap.js';
...
export function importAseprite(texture: Texture, sheet: AsepriteSheet): { atlas: PixelAtlas; clips: Record<string, SpriteClip> } {
  ...
  return { atlas: new PixelAtlas(texture, { width: sheet.meta.size.w, height: sheet.meta.size.h, frames }), clips };
}
